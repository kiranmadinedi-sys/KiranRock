                    ...
                    <div className="flex items-center justify-between h-14 sm:h-16 gap-2">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="hidden sm:block">
                                <div className="flex items-center gap-2">
                                    <h1 className="text-base lg:text-lg font-bold text-white">AI Trading Pro</h1>
                                    <span className="px-1.5 py-0.5 bg-green-500 text-white text-[10px] sm:text-xs font-bold rounded animate-pulse">LIVE</span>
                                </div>
                                <p className="text-[10px] sm:text-xs text-gray-400">Professional Trading</p>
                            </div>
                        </div>

                        {/* Market Status - Desktop Only */}
                        <div className="hidden xl:flex items-center gap-4">
                            <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium ${getMarketStatusColor()}`}>
